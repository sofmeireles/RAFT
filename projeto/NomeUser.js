    ...
    create(){
        ...
        this.btnProx.on("pointerup", ()=>{
            ...
            if (this.flag==1){
                ...
                this.scene.start("inicio",{chave:true,firstTime:0,listaPaus: this.listaPaus, nameuser:this.nameuser, listaPerguntas:this.listaPerguntas,tempo:0, posX: 400, posY: 400});
            }
            else{
